...
class GeminiClient:
    def __init__(self):
        ...
        self.categories = self._load_json_data("/home/lee/Desktop/Projects/tempanzeige/app/data/categories.json")
        self.cities = self._load_json_data("/home/lee/Desktop/Projects/tempanzeige/app/data/cities.json")
